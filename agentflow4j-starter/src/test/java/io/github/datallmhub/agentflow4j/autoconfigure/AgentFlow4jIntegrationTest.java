 ...
 * </ul>
 */
@SpringBootTest(classes = AgentFlow4jIntegrationTest.TestConfig.class)
class AgentFlow4jIntegrationTest {
    ...
    @Configuration
    @ImportAutoConfiguration(AgentFlow4jAutoConfiguration.class)
